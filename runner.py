...
# ===============================================================================
# Debugging
# run("python run_game.py 2 2 1 n simple_player competition_player")
# run("python run_game.py 2 2 1 n better_player competition_player")
#
# run("python run_game.py 2 2 1 n competition_player simple_player")
# run("python run_game.py 2 2 1 n competition_player better_player")
